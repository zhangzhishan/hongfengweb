...
<div class="container">
  ...
  <div class="modules">
    ...
    <div class="row">
      <div class="col-sm-12 text-center"> <a class="btn btn-default" href="http://www.Code4Fun.com/index.php?route=extension/extension&utm_source=Code4Fun_install&utm_medium=store_link&utm_campaign=Code4Fun_install" target="_BLANK"><?php echo $text_store; ?></a> </div>
    </div>
  </div>
  <div class="mailing-list">
    <div class="row">
      <div class="col-sm-12"> <img src="view/image/icon-mail.png">
        ...
        <a class="btn btn-secondary" href="http://newsletter.Code4Fun.com/h/r/B660EBBE4980C85C" target="_BLANK"><?php echo $button_join; ?></a> </div>
    </div>
  </div>
  <div class="core-modules">
    <div class="row">
      <div class="col-sm-6 text-center"> <img src="view/image/openbay_pro.gif">
        <p><?php echo $text_openbay; ?> <a href="http://www.openbaypro.com/?utm_source=Code4Fun_install&utm_medium=referral&utm_campaign=Code4Fun_install"><?php echo $text_more_info; ?></a></p>
      ...
      <div class="col-sm-6 text-center"> <img src="view/image/maxmind.gif">
        <p><?php echo $text_maxmind; ?> <a href="http://www.maxmind.com/?utm_source=Code4Fun_install&utm_medium=referral&utm_campaign=Code4Fun_install"><?php echo $text_more_info; ?></a></p>
        <a class="btn btn-primary" href="<?php echo $link_maxmind; ?>"><?php echo $button_setup; ?></a> </div>
    </div>
  </div>
  <div class="support text-center">
    <div class="row">
      <div class="col-sm-4"> <a href="https://www.facebook.com/pages/Code4Fun/477182382328323" class="icon transition"> <i class="fa fa-facebook fa-4x"></i> </a>
        <h3><?php echo $text_facebook; ?></h3>
        <p><?php echo $text_facebook_info; ?></p>
        <a href="https://www.facebook.com/pages/Code4Fun/477182382328323"><?php echo $text_facebook_link; ?></a> </div>
      <div class="col-sm-4"> <a href="http://forum.Code4Fun.com/?utm_source=Code4Fun_install&utm_medium=forum_link&utm_campaign=Code4Fun_install" class="icon transition"> <i class="fa fa-comments fa-4x"></i> </a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_info; ?></p>
        <a href="http://forum.Code4Fun.com/?utm_source=Code4Fun_install&utm_medium=forum_link&utm_campaign=Code4Fun_install"><?php echo $text_forum_link; ?></a> </div>
      <div class="col-sm-4"> <a href="http://www.Code4Fun.com/index.php?route=partner/partner&utm_source=Code4Fun_install&utm_medium=partner_link&utm_campaign=Code4Fun_install" class="icon transition"> <i class="fa fa-user fa-4x"></i> </a>
        <h3><?php echo $text_commercial; ?></h3>
        <p><?php echo $text_commercial_info; ?></p>
        <a href="http://www.Code4Fun.com/index.php?route=partner/partner&utm_source=Code4Fun_install&utm_medium=partner_link&utm_campaign=Code4Fun_install" target="_BLANK"><?php echo $text_commercial_link; ?></a> </div>
    </div>
  </div>
</div>
<?php echo $footer; ?> 
