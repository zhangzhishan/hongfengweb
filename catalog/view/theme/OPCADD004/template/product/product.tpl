    ...
    <?php } ?>
        ...
        <?php } ?>
          ...
          <div id="product">
			...
			<button type="button" class="wishlist_button btn btn-default" id="wishlist" onclick="wishlist.add('<?php echo $product_id; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_wishlist; ?></span></button>
            <button type="button" class="compare_button btn btn-default" id="compare" onclick="compare.add('<?php echo $product_id; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_compare; ?></span></button>
            </div>
