...
<ul class="breadcrumb">
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> contact"><?php echo $content_top; ?>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
		  ...
		  <div class="left-content">
			...
			<div class="map">
			 <script type="text/javascript" src="http://www.webestools.com/google_map_gen.js?lati=21.182785&long=72.831834&zoom=4&width=400&height=200&mapType=normal&map_btn_normal=yes&map_btn_satelite=yes&map_btn_mixte=yes&map_small=yes&marqueur=yes&info_bulle="></script>
		 </div> 
            <div class="col-sm-3">
              <?php if ($open) { ?>
